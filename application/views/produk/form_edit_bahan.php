...
$attributes = array('class'=>'form-horizontal','role'=>'form');
	echo form_open_multipart($this->uri->segment(1).'/edit_pimpinan',$attributes); 
?>
             ...
             <div class="card mb-4">
                 ...
                 <div class="card-body">
                         ...
                         <div class="form-group">
                             ...
                             <input type="text" name="nama" class="form-control" value="<?=$rows['nama'];?>" required>
                         </div>
						 <div class="form-group">
						...
						<div class="form-group">
							 ...
							 <?php 
							  $akses =$this->model_app->view_ordering('jabatan','id_jabatan','ASC');
							 foreach($akses AS $key=>$val){
							 if($val['id']==$rows['id_user']){
