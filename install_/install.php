...
if($_SERVER['REQUEST_METHOD'] == 'POST' && $_POST) {
	...
	if($core->checkEmpty($_POST) == true)
	{
            ...
            else if ($core->write_routes() == false)
			{
                    $message = $core->show_message('error',"The routes.php configuration file could not be written, please chmod application/config/routes.php file to 777");
			}
            else if ($core->write_autoload() == false)
			{
                    $message = $core->show_message('error',"The autoload.php configuration file could not be written, please chmod application/config/autoload.php file to 777");
			}
			else if ($core->hapus_welcome() == false)
			{
                    $message = $core->show_message('error',"The Welcome.php cant't be delete, please chmod application/controller/Welcome.php file to 777");
			}
			else if ($core->rename_htacess() == false)
			{
                    $message = $core->show_message('error',"The htacess cant't rename to .htacess, please chmod htacess file to 777");
			}
	}
	else {
